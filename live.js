...
<script type="text/javascript">
	...
	if (!is.edge() && !is.chrome() && !is.firefox() && !is.opera() && (!is.safari() || isUCBrowser)) {
	...
	if ((is.chrome() && chromeVersion <= 41) || (is.firefox() && firefoxVersion <= 32) || (is.opera() && operaVersion <= 28) || (is.safari() && (safariVersion <= 600 || safariVersion >= 6533))) {
...
function eventFormValidation() {
	...
	console.log($(billingCard).is(':checked'));
