...
const discountCodeValidation = () => {
	...
	return discountCode.test(/[a-zA-Z0-9]{16,17}/igm) ? discountCode.substr(discountCode.length - eventCode.length).toLowerCase() === eventCode.toLowerCase() && calculateDiscount(discountCode) : null
}
