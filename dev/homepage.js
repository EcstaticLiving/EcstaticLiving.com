...
const fadeInTab = tabIndex => {
	console.log(getElementByClassName('background-red', tabIndex))
	console.log(getElementByClassName('background-red', tabIndex).classList.contains('w-condition-invisible'))
